...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <h1 className="text-4xl font-bold text-seductive mb-4">Welcome to {SITE_NAME}</h1>
      <p className="mb-8 text-white">To get started, please login to {TARGET_SITE_NAME}</p>
